...
var origin_left_eye_postion
var origin_left_eye_scale

@onready var right_eye = $display/SubViewport/right_eye
var origin_right_eye_position
var origin_right_eye_scale
...
func _process(delta):
	if socket.get_available_packet_count() > 0:
		...
		#left_eye.position.y = origin_left_eye_postion.y + (top_left_eye_delta - bottom_left_eye_delta) * -5
		#right_eye.position.y = origin_right_eye_position.y + (top_right_eye_delta - bottom_right_eye_delta) * -5
